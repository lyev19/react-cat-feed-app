...
exports.activateAlarmById = void 0;
// libs
var react_native_1 = require("react-native");
var react_native_push_notification_1 = __importDefault(require("react-native-push-notification"));
// local
var editAlarmWithoutActivateAlarm_1 = require("./libraryOnlyHelpers/editAlarmWithoutActivateAlarm");
var getAlarms_1 = require("./getAlarms");
var activateAlarmById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                date = alarm.date;
                now = Date.now();
                if (!(now > new Date(date).getTime())) return [3 /*break*/, 4];
            ...
            case 3:
                ...
                date = addDayToDate;
                return [3 /*break*/, 6];
            case 4: return [4 /*yield*/, (0, editAlarmWithoutActivateAlarm_1.editAlarmWithoutActivateAlarm)(Object.assign({}, alarm, {
                    active: true,
                }))];
            case 5:
                _a.sent();
...
exports.activateAlarmById = activateAlarmById;
exports.default = exports.activateAlarmById;
